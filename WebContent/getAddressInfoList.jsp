			...
			<section id="main-section">
				...
				<form name="orderForm" method="post">
					<table border="1" cellpadding="0" cellspacing="0" width="700" align="center">
						...
						%>
						<tr align="center">
							<td><%=addressInfo.getZipCode()%></td>
							<td><%=addressInfo.getBaseAddress() %></td>
							<td><%=addressInfo.getDetailAddress() %></td>	
							<td>
								<input type="button" value="수정" onclick="location.href='getAddressInfo.do?zipCode=<%=addressInfo.getZipCode() %>'">
								<input type="button" value="삭제" onclick="location.href='deteteAddressInfo.do?zipCode=<%=addressInfo.getZipCode() %>'">
							</td>
						</tr>
						<%
							}
					...
					<input type="button" value="배송지 등록" onclick="location.href='insertAddressInfo.jsp'"></button>
				</form>
			</section>
		</div>
