	...
	<div id="page-wrapper">
		...
		<div id="content">
			<section id="main-section">
				<h1>장바구니 목록</h1>
				<form name="orderForm" method="post" action="prepareOrder.do">
					<input type="hidden" value="shoppingBasketList" name="from"/>
					<table border="1" cellpadding="0" cellspacing="0" width="700" align="center">
						<tr>
							...
							<th bgcolor="#CCCCCC" width="100">추가날짜</th>
							<th bgcolor="#CCCCCC" width="40" >처리</th>
						</tr>
						<%
						...
						<tr align="center">
							...
							<td align="left"><a href="getBook.do?bookNum=<%=shoppingBasket.getBook_bookNum() %>"><%=shoppingBasket.getBook_bookName()%></a></td>
							<td><%=shoppingBasket.getQty() %></td>
							<td><%=shoppingBasket.getAmount()%></td>	
							<td><%=shoppingBasket.getAddDate() %></td>
							<td><input type="button" value="삭제" onclick="location.href='deteteShoppingBasket.do?bookNum=<%=shoppingBasket.getBook_bookNum()%>'"></td>
						</tr>
						<%
							}
						%>
