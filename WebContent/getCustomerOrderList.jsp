...
<%
	// 세션에 저장된 글 목록을 꺼낸다.
	List<CustomerOrderVO> customerOrderList = (List) session.getAttribute("customerOrderList");
	//세션에 저장된 유저 정보를 꺼낸다
			...
			<section id="main-section">
				<h1>주문 내역</h1>
					<table border="1" cellpadding="0" cellspacing="0" width="800" align="center">
						<tr>
							<th bgcolor="#CCCCCC" width="70" >주문번호</th>
							<th bgcolor="#CCCCCC" >주문일자</th>
							<th bgcolor="#CCCCCC" >결제금액</th>
							<th bgcolor="#CCCCCC" >우편번호</th>
							<th bgcolor="#CCCCCC" width="250">기본주소</th>
							<th bgcolor="#CCCCCC" >상세주소</th>
						</tr>
						<%
							for (CustomerOrderVO customerOrder : customerOrderList) {
						%>
						<tr align="center">
							<td><a href="getCustomerOrderDetail.do?orderNum=<%=customerOrder.getOrderNum() %>"><%=customerOrder.getOrderNum()%></a></td>
							<td><%=customerOrder.getOrderDate()%></td>
							<td><%=customerOrder.getPaymentAmount() %></td>
