			...
			<section id="main-section">
				...
				<form name="orderForm" method="post">
					<table border="1" cellpadding="0" cellspacing="0" width="700" align="center">
						<tr>
							<th bgcolor="#CCCCCC" >카드번호</th>
							<th bgcolor="#CCCCCC" >유효기간</th>
							<th bgcolor="#CCCCCC" >카드종류</th>
							<th bgcolor="#CCCCCC" >처리</th>
						</tr>
						<%
							for (CreditCardInfoVO creditCardInfo : creditCardInfoList) {
						%>
						<tr align="center">
							<td><%=creditCardInfo.getCardNum()%></td>
							<td><%=creditCardInfo.getExpirationDate() %></td>
							<td><%=creditCardInfo.getCardType() %></td>	
							<td>
								<input type="button" value="수정" onclick="location.href='getCreditCardInfo.do?cardNum=<%=creditCardInfo.getCardNum() %>'">
								<input type="button" value="삭제" onclick="location.href='deleteCreditCardInfo.do?cardNum=<%=creditCardInfo.getCardNum() %>'">
							</td>
						</tr>
						<%
							}
					...
					<input type="button" value="카드정보 등록" onclick="location.href='insertCreditCardInfo.jsp'"></button>
				</form>
			</section>
		</div>
