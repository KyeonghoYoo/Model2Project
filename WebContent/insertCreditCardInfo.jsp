	...
	<!-- 헤더 -->
		...
		<div id="content">
			<section id="main-section">
				<h1>카드정보 등록</h1>
				<form action="insertCreditCardInfo.do" method="post">
					<table border="1" cellpadding="0" cellspacing="0">
						<tr>
							<td bgcolor="#CCCCCC">카드번호</td>
							<td><input type="text" name="num1" maxlength="4" width="100" /><input
								type="text" name="num2" maxlength="4" /><input type="text"
								name="num3" maxlength="4" /><input type="text" name="num4"
								maxlength="4" /></td>
						</tr>
						<tr>
							<td bgcolor="#CCCCCC">유효기간</td>
							<td><input type="text" name="month" placeholder="MM"
								maxlength="2" /><input type="text" name="year"
								placeholder="YY" maxlength="2" /></td>
						</tr>
						<tr>
