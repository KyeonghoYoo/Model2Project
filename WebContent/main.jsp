	...
	<div id="page-wrapper">
		...
		<div id="content">
			<section id="main-section">
				...
				%>
					<article>
						<a href="getBook.do?bookNum=<%=book.getBookNum() %>">
							<div class="article-body">
								<img src="<%=book.getUrl() %>" alt="<%=book.getBookName()%>" />
								<p id="product-name"><%=book.getBookName() %></p>
								<p id="product-price">￦<%=book.getPrice() %></p>
							</div>
						</a>
					</article>
				<%
