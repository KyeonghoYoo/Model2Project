		...
		<div id="content">
			<section id="main-section">
				...
				<form action="updateAddressInfo.do" method="post">
					<input type="hidden" name="zipCode" value="${addressInfo.zipCode }">
					<table border="1" cellpadding="0" cellspacing="0">
						<tr>
							<td bgcolor="#CCCCCC">우편번호</td>
							<td><input type="text" name="newZipCode" value="${addressInfo.zipCode }"/></td>
						</tr>
						<tr>
							<td bgcolor="#CCCCCC">기본주소</td>
							<td><input type="text" name="baseAddress" value="${addressInfo.baseAddress }"/></td>
						</tr>
						<tr>
							<td bgcolor="#CCCCCC">상세주소</td>
							<td><input type="text" name="detailAddress" value="${addressInfo.detailAddress }" /></td>
						</tr>
						<tr>
